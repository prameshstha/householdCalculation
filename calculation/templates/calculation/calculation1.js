...
function da(p, n){
    ...
    console.log(n);
                ...
                for(i=0; i<=PdataSorted.length; i++){
                    console.log(i, count, 'i and count');
                    if(count<NdataSorted.length){

                        for(j=0; j<=NdataSorted.length; j++){
                            ...
                            if(absGiver>toReceive){
                                ...
                                finalData.push({
                                  ...
                                  if(toReceive>0){
                                      if(PdataSorted.hasOwnProperty['giveORreceive'] != null){
                                        PdataSorted[j]['giveORreceive']=toReceive;
                                        console.log('has property');
                                      }else{
                                        PdataSorted[j+1]['giveORreceive']=toReceive;
